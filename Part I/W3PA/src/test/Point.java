...
public class Point implements Comparable<Point> {
    ...
    public static void main(String[] args) {
    	...
    	System.out.println(points[0] + ": " + points[0].slopeTo(points[0]));
    	System.out.println(points[1] + ": " + points[0].slopeTo(points[1]));
    	System.out.println(points[2] + ": " + points[0].slopeTo(points[2]));
    	System.out.println(points[3] + ": " + points[0].slopeTo(points[3]));
